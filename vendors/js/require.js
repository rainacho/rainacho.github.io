		...
		function i(e, i, r) {
			...
			if (
				(e &&
					((e = e.split('/')),
					(d = e.length - 1),
					y.nodeIdCompat && jsSuffixRegExp.test(e[d]) && (e[d] = e[d].replace(jsSuffixRegExp, '')),
					'.' === e[0].charAt(0) && g && ((m = g.slice(0, g.length - 1)), (e = m.concat(e))),
					t(e),
					(e = e.join('/'))),
				r && v && (g || x))
			) {
					...
					(d
						? (h =
								s && s.normalize
									...
									? i(e, p, n)
									: e)
						: ((h = i(e, p, n)), (c = o(h)), (d = c[0]), (h = c[1]), (r = !0), (a = q.nameToUrl(h)))),
								...
								if (((this.defining = !0), this.depCount < 1 && !this.defined)) {
									if (isFunction(o)) {
										...
										if (
											(this.map.isDefine &&
												void 0 === n &&
												((t = this.module), t ? (n = t.exports) : this.usingExports && (n = this.exports)),
											e)
										)
											return (
							...
							bind(this, function (r) {
								...
								return this.map.unnormalized
									? (r.normalize &&
									  ...
									  (o = a(e.prefix + '!' + l, this.map.parentMap)),
									  u(
											o,
											'defined',
						...
						mixin(o, {
							...
							toUrl: function (e) {
								var r,
									...
									a = '.' === o || '..' === o;
								return (
									n !== -1 && (!a || n > 1) && ((r = e.substring(n, e.length)), (e = e.substring(0, n))),
			...
			(define = function (e, t, i) {
				...
				'string' != typeof e && ((i = t), (t = e), (e = null)),
					...
					useInteractive &&
						...
						r && (e || (e = r.getAttribute('data-requiremodule')), (n = contexts[r.getAttribute('data-requirecontext')]))),
